...
export default function Toolbar({
  ...
  return (
    <div className="toolbar" role="toolbar" aria-label="Graph editor toolbar">
      ...
      <button data-testid="toolbar-export" data-testid="export-json" className="secondary" onClick={() => onExport({ gzip: false })} disabled={busy} title="Export JSON">Export</button>
